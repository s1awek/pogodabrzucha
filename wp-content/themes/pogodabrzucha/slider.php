  ...
  <div class="slideshow-container">
    ...
    <div class="mySlides">
      <div class="slider-info" id="slide1">
        ...
        <div class="diet-banner-buttons fade"><a class="border-button border-button--white fill-button " href="<?php the_field('slider:_slide_info_url_1')['url']; ?>">więcej info
          </a><a class="gold-button border-button border-button--solid" href="<?php the_field('slider_slide_order_url_1')['url']; ?>">zamów</a></div>
      </div>
      <div class="slide-img">
        <?php
    ...
    <div class="mySlides d-none">
      <div class="slider-info " id="slide2">
        ...
        <div class="diet-banner-buttons fade"><a class="border-button border-button--white fill-button " href="<?php the_field('slider:_slide_info_url_2')['url']; ?>">więcej info
          </a><a class="gold-button border-button border-button--solid" href="<?php the_field('slider_slide_order_url_2')['url']; ?>">zamów</a></div>
      </div>
      <div class="slide-img">
        <?php
    ...
    <div class="mySlides d-none">
      <div class="slider-info " id="slide3">
        ...
        <div class="diet-banner-buttons fade"><a class="border-button border-button--white fill-button " href="<?php the_field('slider:_slide_info_url_3')['url']; ?>">więcej info
          </a><a class="gold-button border-button border-button--solid" href="<?php the_field('slider_slide_order_url_3')['url']; ?>">zamów</a></div>
      </div>
      <div class="slide-img">
        <?php
