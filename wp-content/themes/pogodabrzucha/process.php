        ...
        <div class="section-process__steps ">
            <div class="section-process__steps-step section-process__steps-step--1">
                ...
                if (!empty($process1img)) : ?>
                    <img class="step-img" src="<?php echo esc_url($process1img['url']); ?>" alt="<?php echo esc_attr($process1img['alt']); ?>" />
                <?php endif; ?>
            ...
            <div class=" section-process__steps-step section-process__steps-step--2">
                ...
                if (!empty($process2img)) : ?>
                    <img class="step-img" src="<?php echo esc_url($process2img['url']); ?>" alt="<?php echo esc_attr($process2img['alt']); ?>" />
                <?php endif; ?>
            ...
            <div class="section-process__steps-step section-process__steps-step--3">
                ...
                if (!empty($process3img)) : ?>
                    <img class="step-img" src="<?php echo esc_url($process3img['url']); ?>" alt="<?php echo esc_attr($process3img['alt']); ?>" />
                <?php endif; ?>
            ...
            <div class="section-process__steps-step section-process__steps-step--4">
                ...
                if (!empty($process4img)) : ?>
                    <img class="step-img" src="<?php echo esc_url($process4img['url']); ?>" alt="<?php echo esc_attr($process4img['alt']); ?>" />
                <?php endif; ?>
            ...
            <div class="section-process__steps-step section-process__steps-step--5">
                ...
                if (!empty($process5img)) : ?>
                    <img class="step-img" src="<?php echo esc_url($process5img['url']); ?>" alt="<?php echo esc_attr($process5img['alt']); ?>" />
                <?php endif; ?>
        ...
        <div class="section-process__steps--mobile">
            <div class="section-process__steps--mobile-step">
                ...
                if (!empty($process1Mimg)) : ?>
                    <img class="step-img" src="<?php echo esc_url($process1Mimg['url']); ?>" alt="<?php echo esc_attr($process1Mimg['alt']); ?>" />
                <?php endif; ?>
                <p><?php the_field('process_first_txt'); ?></p>
            ...
            <div class="section-process__steps--mobile-step">
                ...
                if (!empty($process2Mimg)) : ?>
                    <img class="step-img" src="<?php echo esc_url($process2Mimg['url']); ?>" alt="<?php echo esc_attr($process2Mimg['alt']); ?>" />
                <?php endif; ?>
                <p><?php the_field('process_second_txt'); ?></p>
            ...
            <div class="section-process__steps--mobile-step">
                ...
                if (!empty($process1Mimg)) : ?>
                    <img class="step-img" src="<?php echo esc_url($process3Mimg['url']); ?>" alt="<?php echo esc_attr($process3Mimg['alt']); ?>" />
                <?php endif; ?>
                <p><?php the_field('process_third_txt'); ?></p>
            ...
            <div class="section-process__steps--mobile-step">
                ...
                if (!empty($process4Mimg)) : ?>
                    <img class="step-img" src="<?php echo esc_url($process4Mimg['url']); ?>" alt="<?php echo esc_attr($process4Mimg['alt']); ?>" />
                <?php endif; ?>
                <p><?php the_field('process_fourth_txt'); ?></p>
            ...
            <div class="section-process__steps--mobile-step">
                ...
                if (!empty($process5Mimg)) : ?>
                    <img class="step-img" src="<?php echo esc_url($process5Mimg['url']); ?>" alt="<?php echo esc_attr($process5Mimg['alt']); ?>" />
                <?php endif; ?>
                <p><?php the_field('process_fifth_txt'); ?></p>
