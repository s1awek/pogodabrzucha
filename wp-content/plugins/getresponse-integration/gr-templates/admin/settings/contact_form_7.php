        ...
        <td>
            ...
            <ol>
                <li>Paste the following snippet into the contact form template. Customize the call to action to suit your brand identity and encourage people to sign up.
                    <p><code class="getresponse">&lt;label&gt;[acceptance signup-to-newsletter id:signup-to-newsletter class:signup-to-newsletter optional] Sign up to our newsletter! [/acceptance]&lt;/label&gt;</code></p>
                </li>
                <li>Change the name of the email input field to:
                    <p><code class="getresponse"><label>Your Email (required) [email* email]</label></code></p>
                </li>
                <li>
